...
using JPBlazor.Application.Features.ExtendedAttributes.Commands.Delete;
...
using JPBlazor.Application.Features.ExtendedAttributes.Queries.GetById;
using JPBlazor.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace JPBlazor.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
