...
using JPBlazor.Client.Infrastructure.Authentication;
using JPBlazor.Client.Infrastructure.Managers;
using JPBlazor.Client.Infrastructure.Managers.Preferences;
...
using JPBlazor.Client.Infrastructure.Managers.ExtendedAttribute;
using JPBlazor.Domain.Entities.ExtendedAttributes;
using JPBlazor.Domain.Entities.Misc;
using Toolbelt.Blazor.Extensions.DependencyInjection;

namespace JPBlazor.Client.Extensions
{
