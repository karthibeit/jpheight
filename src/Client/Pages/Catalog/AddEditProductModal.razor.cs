...
using JPBlazor.Client.Infrastructure.Managers.Catalog.Brand;
using JPBlazor.Client.Infrastructure.Managers.Catalog.Product;

namespace JPBlazor.Client.Pages.Catalog
{
